...
const Card = (props) => {
  ...
  const { educator, duration, likes, thumbnail_url, title, views, _id } =
    props.prop;
  let url = "";
  if (isEducator == "true") {
    url = "";
  ...
  axios.get(`${baseUrl}/findAllEducators/${educator}`).then((res) => {
        ...
        <div className="cardItem">
          <div className="thumbnailContainer">
            ...
            <div className="videoDurationData">
              <img
                ...
                src="https://edyoda.com/static/media/icon-play-blue.68696826.svg"
                alt="play icon"
              />
          ...
          <div className="videoMetaData">
            ...
            <div className="videoOwnerData">
              <div className="videoMetaDataSection">
                <span>{author}</span>
