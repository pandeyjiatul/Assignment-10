  ...
  return (
    <div className={style.Footer__Footer__2T3w3}>
      <div className={style.Footer__Row__2Koch}>
        ...
        <div className={style.Footer__Column__1mRXM}>
          <h3 className={style.Footer__ColumnHeading__sK9kQ}>
            FOR ENTERPRISES
          </h3>
        ...
        <div
          className={`${style.Footer__Column__1mRXM} ${style.Footer__SocialLinksContainer__2kpSA}`}
        >
          <h3 className={style.Footer__ColumnHeading__sK9kQ}>CONNECT</h3>
          <div className={style.Footer__Column__1mRXM}>
            <a className={style.Footer__AddressText__1CPUN}>
            ...
            <a href="mailto:hello@edyoda.com" target="_blank" rel="noreferrer">
              <img
                ...
                className={style.Footer__ContactIcon__2TTbB}
              />
              hello@edyoda.com
            </a>
            <div className={style.Footer__SocialLinks__174hs}>
              ...
              >
                <img
                  ...
                  className={style.Footer__SocialIcon__2m5Mx}
                />
              </a>
              <a
                target="_blank"
              ...
              >
                <img
                  ...
                  className={`${style.Footer__facebookIcon__193xx} ${style.Footer__SocialIcon__2m5Mx}`}
                />
              </a>
              <a
                target="_blank"
